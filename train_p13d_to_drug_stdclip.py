...
from models.model_p13d_to_drug_stdclip import MyModelMDTAP13DToDrugSTDCLIP
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/davis_p13d_to_drug_stdclip")
    ...
    print("MODEL: standard CLIP between drug and protein on top of p13d backbone")

    save_split_indices(train_set, val_set, args.output_dir)

    model = MyModelMDTAP13DToDrugSTDCLIP(
