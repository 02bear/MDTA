...
from models.model_d12d_p13d import MyModelMDTAD12DP13D
...
def build_model(args, device):
    model = MyModelMDTAD12DP13D(
        drug_1d_in_dim=args.drug_1d_in_dim,
        drug_2d_node_dim=args.drug_2d_node_dim,
...
def main():
    ...
    # train
    parser.add_argument("--output_dir", type=str, default="outputs/davis_d12d_p13d")
    ...
    parser.add_argument("--drug_2d_node_dim", type=int, default=43)
    ...
    print("MODEL: drug(1d+2d) + protein(1d+3d)")
