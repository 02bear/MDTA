...
from models.model_p13d_softclip import MyModelMDTAP13DSOFTCLIP
    ...
    for step, batch in enumerate(loader):
        ...
        if (step + 1) % log_interval == 0:
            ...
            print(
                ...
                f"MEAN_VALID_PER_ROW={aux['mean_valid_per_row'].item():.2f} | "
                f"MEAN_VALID_OFFDIAG={aux['mean_valid_offdiag'].item():.2f} | "
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/davis_p13d_softclip")
    ...
    print("MODEL: drug_1d + protein_1d + protein_3d + affinity-aware soft CLIP")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(
            ...
            f"SOFTCLIP={train_metrics['clip_loss']:.6f} | "
        ...
        print(
            ...
            f"SOFTCLIP={val_metrics['clip_loss']:.6f} | "
